...
func TestParseAttributeNamedResidentAttribute(t *testing.T) {
	...
	expected := mft.Attribute{Type: 0x80, Resident: true, Name: "$SRAT", Flags: mft.AttributeFlags{0x0, 0x0}, AttributeId: 5, Data: []byte{0x33, 0xce, 0xb8, 0xf3, 0x38, 0x0, 0x1, 0x3, 0x10, 0x0, 0xc, 0x0, 0x4, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x3, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf4, 0xc4, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}}
	assert.Equal(t, expected, attribute)
}

func TestParseAttributeNamedNonResidentAttribute(t *testing.T) {
	input, err := hex.DecodeString("a000000050000000010440000000080000000000000000000200000000000000480000000000000000300000000000000030000000000000003000000000000024004900330030002103081200000000")
	require.Nilf(t, err, "unable to convert input hex to []byte: %v", err)

	attribute, err := mft.ParseAttribute(input)
	require.Nilf(t, err, "error parsing attribute: %v", err)

	expected := mft.Attribute{Type: 0xA0, Resident: false, Name: "$I30", Flags: mft.AttributeFlags{0x0, 0x0}, AttributeId: 8, Data: []byte{0x21, 0x3, 0x8, 0x12, 0x0, 0x0, 0x0, 0x0}}
	assert.Equal(t, expected, attribute)
}

func TestParseRecordFixup(t *testing.T) {
	input, err := hex.DecodeString("")
	require.Nilf(t, err, "unable to convert input hex to []byte: %v", err)
