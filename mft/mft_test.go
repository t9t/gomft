...
func TestParseAttributes(t *testing.T) {
	...
	expectedAttributes := []mft.Attribute{
		...
		mft.Attribute{Type: 176, Resident: false, Flags: 0, AttributeId: 7, Data: []byte{0x41, 0x3A, 0xBE, 0x84, 0x83, 0x0, 0x0, 0x0}},
	}
...
func TestParseAttributeNamedNonResidentAttribute(t *testing.T) {
	...
	expected := mft.Attribute{Type: 0xA0, Resident: false, Name: "$I30", Flags: 0, AttributeId: 8, Data: []byte{0x21, 0x3, 0x8, 0x12, 0x0, 0x0, 0x0, 0x0}}
	assert.Equal(t, expected, attribute)
}
